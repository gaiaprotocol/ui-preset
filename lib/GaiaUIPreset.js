...
import { AccordionCloseIcon, AccordionOpenIcon, BoldIcon, BulletListIcon, CloseIcon, CodeBlockIcon, CodeIcon, ErrorIcon, FolderCollapsedIcon, FolderExpandedIcon, HeadingIcon, ImageIcon, InfoIcon, ItalicIcon, LinkIcon, LogoutIcon, MinusIcon, MoreVertIcon, NumberListIcon, PlusIcon, QuoteIcon, SendIcon, StrikethroughIcon, SuccessIcon, TableIcon, VideoIcon, WarningIcon } from "@gaiaprotocol/svg-icons";
class GaiaUIPreset {
    init() {
