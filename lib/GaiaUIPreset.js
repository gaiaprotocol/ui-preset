...
import { AccordionCloseIcon, AccordionOpenIcon, CloseIcon, ErrorIcon, InfoIcon, LogoutIcon, MinusIcon, PlusIcon, SendIcon, SuccessIcon, WarningIcon, } from "@gaiaprotocol/svg-icons";
class GaiaUIPreset {
    init() {
